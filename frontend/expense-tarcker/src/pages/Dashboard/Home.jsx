...
import ExpenesTransactions from "../../components/cards/ExpenesTransactions";
...
const Home = () => {
  ...
  const fetchDashboardData = async () => {
    ...
    try {
      // ✅ No backticks/newlines, axiosInstance handles BASE_URL
  ...
  // ✅ Only run once on mount, no infinite loop
  useEffect(() => {
    fetchDashboardData();
  }, []);
    ...
    <DashboardLayout activeMenu="Dashboard">
      <div className="my-5 mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
          ...
          <ExpenesTransactions
            transactions={dashboardData?.last30DaysExpenes?.transactions || []}
            onSeeMore={() => navigate("/expense")}
          />
